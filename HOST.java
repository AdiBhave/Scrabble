...
class Test extends Thread{
    ...
    JFrame f, menu;
    Random r=new Random();
     /* -> Buttons in the Menu */ JButton Exit, Host; 
     /* -> Messages in the Menu */ JLabel status, title;
	...
	Host = new JButton("Host a new game"); Host.setActionCommand("1"); Host.addActionListener(new OptionPaneListeners()); Host.setBounds(700, 300, 300, 100);
    ...
    private void updateUI(){
    	status.setText("Connected To Player 2,Lets play");
    	t.start();
        addGrid();
	    addTiles();
	    addColor();
    ...
    private class OptionPaneListeners implements ActionListener{
    	public void actionPerformed(ActionEvent e){
    		...
    		if(Integer.parseInt(s) == 1){
    			...
    			status.setText("Waiting FOR 2ND PLAYER TO JOIN");
